...
public class JavaMongoDbDemo {
	...
	public static void main(String[] args) {
		try {
			...
			BasicDBObject documentAddressObj;
			String address[];
			for(int i = 0 ; i < array_names.length ; i++) {
				documentObj = new BasicDBObject();
				documentAddressObj=new BasicDBObject();
				...
				address = pickAddress();				
				documentAddressObj.append("country", address[0]);//Changes by 184145
				...
				documentObj.append("address", documentAddressObj);
